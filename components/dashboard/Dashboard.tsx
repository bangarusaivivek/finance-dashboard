  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className={cn("flex-1 flex flex-col transition-all duration-300", isFilterOpen ? "lg:ml-80" : "ml-0")}>
        ...
        <div className="sticky top-0 z-20 flex items-center justify-between p-6 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
